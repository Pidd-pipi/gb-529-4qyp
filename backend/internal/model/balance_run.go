...
type BalanceRun struct {
	...
	OpeningSnapshotID   uint                     `json:"opening_snapshot_id" gorm:"not null;index"`
	ClosingSnapshotID   uint                     `json:"closing_snapshot_id" gorm:"not null;index"`
	OpeningReleaseBasis string                   `json:"opening_release_basis" gorm:"size:1000"`
	ClosingReleaseBasis string                   `json:"closing_release_basis" gorm:"size:1000"`
